...
import { useGetMultiMessages } from "~/apis/message.api";
...
import { useChatSocket } from "~/socket/hooks/use-chat-socket";
          ...
          <CardHeader>
            <div className="flex gap-x-4 items-center">
              ...
              <div>
                ...
                >
                  {!checkOnl(onlUserIds, participantIds) ? "Không" : "Đang"}{" "}
                  hoạt động
                </CardDescription>
              </div>
            </div>
            ...
            <form onSubmit={handleSubmit(onSubmit)}>
              <div className="relative border-t">
                <div className="absolute top-[108px] right-1">
                  <CircularProgress
                    value={
                      isNaN(contentValue?.length) ? 0 : contentValue?.length
                    }
